...
//Scrolling Command (more than one bytes command please refer to SSD1306 datasheet for details)
...
//Addressing Setting Command (more than one bytes command please refer to SSD1306 datasheet for details)
...
class SSD1306_Mini {
  ...
  public:
    ...
    void print5x7Char( char ch );
    
    // print a string to the screen
    void print5x7String( char * pText );

	 // print a single character
    void print6x8Char( char ch );
    
    // print a string to the screen
    void print6x8String( char * pText );
    
    void print8x16Char( uint8_t x, uint8_t y, char ch); //Character and location to display it
    void print8x16String( uint8_t x, uint8_t y, char * pText ) ; //Print string of large characters.
